...
$(window).ready(function (window, document) {
    ...
    NotaAzul.Relatorios.BoletoInadimplentes = function () {
        /******************************************************************************************
     ** PRIVATE
     ******************************************************************************************/
        var _dataTable,
        ...
        **/
        var _desenharGrafico = function (jsonObj) {
            ...
            _dataTable.addColumn('string', 'Telefone');
            _dataTable.addColumn('string', 'Responsável');
            _dataTable.addColumn('string', 'CPF');
            _definirAcoesBotoes();
            if (jsonObj != null) {
                var len = jsonObj.length,
                    ...
                    tel;
                for (var i = 0; i < len; i++) {
                    tel = (jsonObj[i].Telefone.length === 9) 
                        ? jsonObj[i].Telefone.substr(0, 5) + "-" + jsonObj[i].Telefone.substr(5, 4)
                        : jsonObj[i].Telefone.substr(0, 4) + "-" + jsonObj[i].Telefone.substr(4, 4)
                    ...
                    rows.push([
                        ...
                        tel,
                        jsonObj[i].Responsavel,
                        Prion.Mascara2(jsonObj[i].ResponsavelCPF,"cpf")
                    ]);
                }
                console.log(rows);
        ...
        **/
        var _iniciar = function () {
            ...
            Prion.Request({
                url: rootDir + "Relatorios/GerarAlunosInadimplentesBoleto",
    ...
    NotaAzul.Relatorios.BoletoInadimplentes.Iniciar();
} (window, document));