...
{
    public class Segmento : Prion.Generic.Models.Base
    {
        private Int32 _id;
        ...
        private List<Models.Curso> _listaCurso;
        ...
        public List<Models.Curso> Cursos
        {
            get
            {
                if (_listaCurso == null) { _listaCurso = new List<Models.Curso>(); }
                return _listaCurso;
            }
            set
            {
                if (_listaCurso != null) { _listaCurso = null; }
                _listaCurso = value;
            }
        }
    }
