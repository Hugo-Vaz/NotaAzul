...
{
    public class ConfiguracaoSistema : Base
    {
          /// <summary>
        ...
        public GenericHelpers.Retorno Salvar(List<GenericModels.ConfiguracaoSistema>config)
        {
            ...
            retorno.Mensagem = "As configurações do sistema foram alteradas com sucesso.As alterações terão efeito na próxima vez em que se logar no sistema";
            return retorno;
